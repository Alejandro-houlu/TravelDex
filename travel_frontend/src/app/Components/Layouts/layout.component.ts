...
@Component({
  selector: 'app-layout',
  standalone: true,
  imports: [TopbarComponent, SidebarComponent, RouterModule, FooterComponent],
...
export class LayoutComponent implements OnInit {
  ...
  constructor(private store: Store<RootReducerState>, private userSvc: CurrentUserService){}
